    ...
    return ( 
        <section className="bg-primary-light-red rounded-bl-[7rem] relative overflow-hidden" id="hero">
            ...
            <div className="container mx-auto h-[80vh] flex flex-col gap-6 items-center justify-center px-8 text-center relative z-20">
                <h1 className="text-3xl text-neutral-white">A modern publishing platform</h1>
                <p className="text-lg text-neutral-white">Grow your audience and build your online brand</p>
                <div className="flex items-center gap-4">
                    <button className="bg-neutral-white px-6 py-2 text-primary-light-red rounded-full font-semibold transition-all ease-linear duration-200">Start for Free</button>
                    <button className="border px-6 py-2 rounded-full text-neutral-white font-semibold transition-all ease-linear duration-200">Learn More</button>
                </div>
            </div>
        </section>
    );
